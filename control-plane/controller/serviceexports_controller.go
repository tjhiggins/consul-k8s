...
// ServiceExportReconciler reconciles a ServiceExports object
...
// the ServiceExports object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.6.4/pkg/reconcile
func (r *ServiceExportReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
...
func (r *ServiceExportReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&consulv1alpha1.ServiceExports{}).
		Complete(r)
}
